...
typedef struct VirtIOPCIProxy VirtIOPCIProxy;		//this struct "connects" a virtio device with the PCI bus of the system
...
struct VirtIOPCIProxy {						//this struct "connects" a virtio device with the PCI bus of the system
    PCIDevice pci_dev;
    MemoryRegion bar;
    uint32_t flags;
    uint32_t class_code;
